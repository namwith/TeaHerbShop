        ...
        <table className="table table-hover align-middle mb-0">
          ...
          <tbody>
            {products.map((p) => {
              ...
              const percentage = Math.min((p.Stock / MAX_CAPACITY) * 100, 100);
                ...
                <tr key={p.ProductID}>
                  <td className="ps-4">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <strong className="d-block text-dark">{p.Name}</strong>
                  ...
                  <td>
                    ...
                    {isLowStock ? (
                      <small className="text-danger fw-bold">
                        <i className="bi bi-exclamation-triangle-fill"></i> Sắp
                        hết hàng!
                      </small>
                    ) : (
                  ...
                  <td className="pe-4 text-end">
                    ...
                    <button
                      className={`btn btn-sm ${p.Status === "hidden" ? "btn-success" : "btn-warning"}`}
                      onClick={() =>
