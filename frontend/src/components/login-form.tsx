...
export function LoginForm({
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!token) {
        toast.error("Server không trả token. Vui lòng thử lại.");
        return;
      }

      // Cập nhật context và localStorage thông qua function login của AuthContext
      login(token, role);
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  Login to your TeaHerbShop account
                </p>
              </div>
